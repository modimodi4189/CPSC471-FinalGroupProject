...
$find_result = mysqli_query($con, "SELECT * FROM `Allergy` WHERE `Email_ID`='$email_E' AND `Name`='$profile_name_E'");
    ...
    if ($_POST["Add_All"]) {
        ...
        if (!isset($_POST["allRadio"])) {
            ...
            if ($_POST["Update_All"]) {
                ...
                require_once("func/funcProf.php");
                $success = updateAllergy($email, $profile_name, $find_all, $up_all, $manageErr);
